...
export default function Home() {
    return (
        <main className="w-375 min-h-[calc(100vh-142px)] mx-auto grid place-items-center max-2xl:w-300 max-xl:w-full max-xl:px-5 max-md:gap-10 max-md:min-h-[calc(100vh-170px)]">
