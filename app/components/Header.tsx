...
export default function Header() {
    return (
        <header className="w-375 mx-auto py-5 flex justify-between items-center select-none max-2xl:w-300 max-xl:w-full max-xl:px-5">
            ...
            <div>
                <HeaderIcon url="https://github.com/harveycoombs" icon={faBars} classes="hidden max-md:inline-block mr-4.5" />
...
function HeaderIcon({ url = "", icon, classes = "", ...rest }: any) {
    const classList = `text-xl ml-4.5 cursor-pointer duration-150 hover:text-gray-300 active:text-white ${classes.length ? classes : ""}`;
